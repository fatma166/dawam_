                                ...
                                <thead>
                                    <tr>
                                       ...
                                       <!-- <th><?php echo e(__('trans.Created Date')); ?></th>-->
                                        ...
                                        <th><?php echo e(__('trans.is_registered')); ?></th>
                                ...
                                <tbody>
                                 ...
                                 <?php $__currentLoopData = $outdoors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $outdoor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                              <?php echo e($outdoor->time_in); ?>

                                        </td>
                                        <td>
                                              <?php echo e($outdoor->time_out); ?>
                                       ...
                                       <td class="text-center">
                                            <?php if($outdoor->is_registered==1): ?><?php echo e(__('trans.done')); ?><?php else: ?> <?php echo e(__('trans.No')); ?><?php endif; ?>
                ...
                <?php echo e($outdoors->appends($search)->links()); ?><?php /**PATH /home/dawam/public_html/manger/resources/views/outdoor_report/search.blade.php ENDPATH**/ ?>