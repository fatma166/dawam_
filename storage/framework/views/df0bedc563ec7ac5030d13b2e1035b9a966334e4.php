            ...
            <div class="account-content">
                <div class="container">
                    ...
                    <div class="account-logo">
                        <a href=""><img src="https://dawam.net/manger/public/img/logo.png" alt="<?php echo e(__('trans.DWAM')); ?>" /></a>
                    </div>
                    <!-- /Account Logo -->
                            ...
                            <form id="register" method="post">
                                ...
                                <div class="tab">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                            <div class="form-group">
                                                <label><?php echo e(__('trans.country')); ?></label>
                                      ...
                                      <!--  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                            <div class="form-group">
                                                <span class="pay-now"><?php echo e(__('trans.pay_now')); ?></span>
                                                <label class="switch">
                                     ...
                                     <div class="col-lg-12">
                                        <div class="form-group form-focus select-focus">
                                            <select class="select floating paymethod dropdown-reg" name="paymethod">
                                                 <option><?php echo e(__('trans.select pay method')); ?></option>
                                                <option value="visa"><?php echo e(__('trans.paypall')); ?></option>
                                                <option value="bank_convert"><?php echo e(__('trans.bank_convert')); ?></option>
                                                <option value="postal_convert"><?php echo e(__('trans.postal_convert')); ?></option>
                                ...
                                <div style="overflow: auto;">
                                    <div style="text-align: center;">
                                        <button class="next-dawam" type="button" id="prevBtn" onclick="nextPrev(1)"><?php echo e(__('trans.Previous')); ?></button>
                                        <button class="prev-dawam" type="button" id="nextBtn" onclick="nextPrev(-1)"><?php echo e(__('trans.Next')); ?></button>
                                    </div>
                                </div>
  ...
  */
                ...
                $("#register input[name='file']").change(function () {
                    ...
                    if (files.length > 0) {
                        ...
                        $.ajax({
                            ...
                            url: '<?php echo e(route("images.signupStoreImage",$subdomain)); ?>',
                            type: "post",
                            data: fd,
                            contentType: false,
                            processData: false,
        ...
        <script>
            ...
            function showTab(n) {
                ...
                $(".switch .slider").click(function () {
                    ...
                    if ($(".check-pay").val() == 1) {
                        ...
                        if (n == 0) {
                            ...
                            document.getElementById("nextBtn").innerHTML ="<?php echo e(__('trans.Next')); ?>";
                        } else if (n > 0 && n < 3) {
                            //alert("tab_b");
                        ...
                        document.getElementById("nextBtn").innerHTML ="<?php echo e(__('trans.Submit')); ?>";
                    }
                });
                ...
                $("#nextBtn").click(function () {
                  valid_input= validateForm();
                        ...
                        if (document.getElementById("nextBtn").innerHTML == "<?php echo e(__('trans.Submit')); ?>"&&valid_input!=false && $(".check-pay").val()==0) {
                            
                            
                            submitRegData([]);

                            //window.location.href = "<?php echo e(route('test2_moaz',$subdomain)); ?>";
                        }else{
                            // nextPrev(currentTab);
            ...
            function nextPrev(n) {
                ...
                // Exit the function if any field in the current tab is invalid:
                 ...
                 if (document.getElementById("nextBtn").innerHTML =="<?php echo e(__('trans.Submit')); ?>"&&n!=-1) {
                       // showTab(currentTab);
                    ...
                    success: function(data) {
                        if (data.hasOwnProperty("success")) {
                               if((document.getElementById("paypal-button-container").innerHTML == "Thank you for your payment!")||($("#attach").val()!=""||data.success=="trans.Added successfully.")){
                                 window.location.href = "<?php echo e(route('show_success',$subdomain)); ?>";
                               }
                        } else {
        ...
        <script type="text/javascript">
            ...
            $("#register input[name='email']").on("keyup", function () {
                ...
                $.ajax({
                    headers: { "X-CSRF-TOKEN": $('meta[name="csrf-token"]').attr("content") },
                    url: '<?php echo e(route("users.check_email",$subdomain)); ?>',
                    type: "post",
                    data: { email: email },
...
<?php /**PATH /home/dawam/public_html/manger/resources/views/register.blade.php ENDPATH**/ ?>