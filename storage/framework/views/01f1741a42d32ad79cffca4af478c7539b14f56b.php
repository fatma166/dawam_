                ...
                <ul>
					      ...
					      <ul style="display:block;">
                             <?php if($roles['name']!="manger"||$roles['name']=="support"): ?>
                                 <li>
                                    ...
                                    <a class="<?php echo e(Request::is('admin/companies') ? 'active' : ''); ?>"
                              ...
                              <?php if($roles['name']=="manger"||($roles['name']=="admin")|| (Session::has('company'))): ?> 
                                <li>
                                    <a class="<?php echo e(Request::is('admin/employee/edit_admin') ? 'active' : ''); ?>"
                              ...
                              <?php if(($roles['name']=="developer"||$roles['name']=="accountant"||$roles['name']=="super_admin")&&(!Session::has('company'))): ?>
                                    ...
                                    <li class="submenu">
                                        ...
                                        <ul style="display: none;">
                                            ...
                                            <li>
                                                <a class="<?php echo e(Request::is('admin/subscribe_index') ? 'active' : ''); ?>"
                                           ...
                                           <!-- <li>
                                            ...
                                            <li>
                                                <a class="<?php echo e(Request::is('admin/company_subscribe') ? 'active' : ''); ?>"
                                    ...
                                    <li class="submenu">
                                            ...
                                            <ul style="display: none;">
                                                ...
                                                <li class="<?php echo e(Request::is('admin/representative') ? 'active' : ''); ?>">
                                    ...
                                    <li>
                                        <a class="<?php echo e(Request::is('admin/payment') ? 'active' : ''); ?>"
                                ...
                                <?php if($roles['name']=="developer"||$roles['name']=="super_admin"&& !(Session::has('company'))): ?>
                                    <li>
                                        <a class="<?php echo e(Request::is('admin/bank') ? 'active' : ''); ?>"
                                  ...
                                  <!-- <li>
                                    ...
                                    <li>
                                        <a class="<?php echo e(Request::is('admin/category') ? 'active' : ''); ?>"
                                ...
                                <?php if(($roles['name']=="admin")|| (Session::has('company'))): ?>
                                   ...
                                   <?php if($roles['name']=="manger"||($roles['name']=="admin")|| (Session::has('company'))): ?> 
                                        <!--<li>
                                         ...
                                         <?php if($roles['name']!="manger"): ?>
                                            <li >
                                                <a class="<?php echo e(Request::is('admin/leave/leave-settings') ? 'active' : ''); ?>"
                                                    href="<?php echo e(route('leave-settings',$subdomain)); ?>"><i class="la la-dot-circle-o"></i> <?php echo e(__('trans.Leave Settings')); ?></a>
                                            </li>
                                          <?php endif; ?>                        
                                        <li>
                                            <a class="<?php echo e(Request::is('admin/outdoor-type') ? 'active' : ''); ?>"
                   ...
                   <li class="submenu">
                        ...
                        <ul style="display: none;">
                            ...
                            <li>
                                <a class="<?php echo e(Request::is('admin/attendance/employee_available/client') ? 'active' : ''); ?>"
                                    href="<?php echo e(url('/admin/attendance/employee_available/'.'client')); ?>" ><?php echo e(__('trans.client_attendance')); ?> </a>
                            </li>                       

                          
                             <li>
                                <a class="<?php echo e(Request::is('admin/attendance/employee_available/branch') ? 'active' : ''); ?>"
                                    href="<?php echo e(url('/admin/attendance/employee_available/'.'branch')); ?>"> <?php echo e(__('trans.branch_attendance')); ?> </a>
                            </li>  
                          
                            <li>
                                <a class="<?php echo e(Request::is('admin/attendance/employee_available/not_dected') ? 'active' : ''); ?>"
                    ...
                    <li class="submenu">
                            <a href="#" class="noti-dot"><i class="la la-user-plus"></i> <span><?php echo e(__('trans.All Employees')); ?></span> <span class="menu-arrow"></span></a>
                                <ul style="display:none;">
                                        ...
                                        <li>
                                            <a class="<?php echo e(Request::is('admin/employees') ? 'active' : ''); ?>"
                     ...
                     <li class="submenu">
                            <a href="#" class="noti-dot"><i class="la la-history"></i> <span><?php echo e(__('trans.User Shifts')); ?></span> <span class="menu-arrow"></span></a>
                                <ul style="display:none;">
                                        <li>
                                            <a class="<?php echo e(Request::is('admin/usershift') ? 'active' : ''); ?>"
                                                href="<?php echo e(route('user_shift_index',$subdomain)); ?>"><?php echo e(__('trans.User Shifts')); ?></a>
                                        </li>
                                </ul>
                     </li>
                     ...
                     <li class="submenu">
                        ...
                        <li class="submenu">
                            ...
                            <ul style="display:none;">
                                ...
                                <li>
                                    <a class="<?php echo e(Request::is('admin/outdoor') ? 'active' : ''); ?>"
                                        href="<?php echo e(route('outdoor',$subdomain)); ?>"><?php echo e(__('trans.Outdoors')); ?></a>
                                </li>
      
                                <li>
                                    <a class="<?php echo e(Request::is('admin/outdoor_question') ? 'active' : ''); ?>"
                        ...
                        <?php if($roles['name']=="manger"||($roles['name']=="admin")|| (Session::has('company'))): ?> 
                          <li class="submenu">
                            ...
                            <ul style="display: none;">
                                ...
                                <li>
                                    <a class="<?php echo e(Request::is('admin/elements-evaluation') ? 'active' : ''); ?>"
                                        href="<?php echo e(route('evaluations',$subdomain)); ?>"> <?php echo e(__('trans.elements-evaluation')); ?> </a>
                                </li>                       
        
                              
                                 <li>
                                    <a class="<?php echo e(Request::is('admin/evaluation_jobs') ? 'active' : ''); ?>"
                                        href="<?php echo e(route('evaluation_jobs',$subdomain)); ?>"> <?php echo e(__('trans.evaluation_jobs')); ?> </a>
                                </li>  
                              
                                <li>
                                    <a class="<?php echo e(Request::is('admin/evaluation_employes') ? 'active' : ''); ?>"
                     ...
                     <li class="submenu">
                            <a href="#" class="noti-dot"><i class="la la-retweet"></i> <span><?php echo e(__('trans.Leaves (Admin)')); ?></span> <span class="menu-arrow"></span></a>
                                <ul style="display:none;">
                                    <li>
                                        <a class="<?php echo e(Request::is('admin/leaves') ? 'active' : ''); ?>"
                                            href="<?php echo e(route('leaves',$subdomain)); ?>"><?php echo e(__('trans.Leaves (Admin)')); ?></a>
                                    </li>
                                </ul>
                     </li>
                    ...
                    <li class="submenu">
                            <a href="#" class="noti-dot"><i class="la la-list-ul"></i> <span><?php echo e(__('trans.Task (Admin)')); ?></span> <span class="menu-arrow"></span></a>
                                <ul style="display:none;">
                                <li>
                                    <a class="<?php echo e(Request::is('admin/task') ? 'active' : ''); ?>"
                        ...
                        <li class="submenu">
                            <a href="#" class="noti-dot"><i class="la la-dashboard"></i> <span><?php echo e(__('trans.Attendance (Admin)')); ?></span> <span class="menu-arrow"></span></a>
                                <ul style="display:none;">
                                   <?php if($roles['name']!="manger"): ?>
                                        <li>
                                            <a class="<?php echo e(Request::is('admin/workflow') ? 'active' : ''); ?>"
                                                href="<?php echo e(route('workflow',$subdomain)); ?>"><?php echo e(__('trans.Workflow')); ?></a>
                                        </li>
                                    <?php endif; ?>
                                    <li>
                                        <a class="<?php echo e(Request::is('admin/attendance') ? 'active' : ''); ?>"
                        ...
                        <li class="submenu">
                            ...
                            <ul style="display:none;">
                                ...
                                <li>
                                    <a class="<?php echo e(Request::is('admin/report-department') ? 'active' : ''); ?>"
                                        href="<?php echo e(route('report-department',$subdomain)); ?>"><?php echo e(__('trans.Department Report')); ?></a>
                                </li>
                                
                                <li>
                                    <a class="<?php echo e(Request::is('admin/report-dialy') ? 'active' : ''); ?>"
                                ...
                                <li>
                                    <a class="<?php echo e(Request::is('admin/month-report') ? 'active' : ''); ?>"
                                        href="<?php echo e(route('month-report',$subdomain)); ?>"><?php echo e(__('trans.Monthly Report')); ?></a>
                                </li>
                                <li>
                                    <a class="<?php echo e(Request::is('admin/visitReport') ? 'active' : ''); ?>"
                                        href="<?php echo e(route('visitReport',$subdomain)); ?>"><?php echo e(__('trans.Visit Report')); ?></a>
                                </li>
                                <li>
                                    <a class="<?php echo e(Request::is('admin/visitTypeReport') ? 'active' : ''); ?>"
                                        href="<?php echo e(route('visitTypeReport',$subdomain)); ?>"><?php echo e(__('trans.Visit Type Report')); ?></a>
                                </li>
                                 <li>
                                    <a class="<?php echo e(Request::is('admin/Evaluation_Report') ? 'active' : ''); ?>"
                     ...
                     <?php if($roles['name']=="developer"||$roles['name']=="accountant"||$roles['name']=="super_admin"): ?>
                        <li class="submenu">
                            ...
                            <ul style="display: none;">
                                 <?php if($roles['name']!="manger"||$roles['name']=="support"): ?>
                                    <li>
                                        <a class="<?php echo e(Request::is('admin/permissions') ? 'active' : ''); ?>"
                                            href="<?php echo e(route('permission',$subdomain)); ?>"><?php echo e(__('trans.All Permissions')); ?></a>
                                    </li>
                                 <?php endif; ?>
                                    <li>
                                        <a class="<?php echo e(Request::is('admin/roles') ? 'active' : ''); ?>"
...
<?php /**PATH /home/dawam/public_html/manger/resources/views/layout/partials/nav.blade.php ENDPATH**/ ?>