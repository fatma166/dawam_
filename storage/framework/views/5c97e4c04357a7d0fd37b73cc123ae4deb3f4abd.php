            ...
            <ul class="nav user-menu">
               ...
               <li class="nav-item dropdown has-arrow flag-nav">
						...
						<a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button">
							...
							<img src="assets/img/flags/us.png" alt="" height="20"> <span><?php if(session()->get('lang')=='AR'): ?><?php echo e('AR'); ?><?php elseif(session()->get('lang')=='EN'): ?><?php echo e('EN'); ?><?php endif; ?></span>
						</a>
...
<?php /**PATH /home/dawam/public_html/manger/resources/views/layout/partials/header.blade.php ENDPATH**/ ?>